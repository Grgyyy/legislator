    ...
    <div class="mx-auto w-full max-w-screen-lg flex flex-col items-center justify-center gap-5 md:gap-10">
        <div class="relative w-full max-w-md">
            <div class="w-2/3 mx-auto overflow-hidden rounded-xl">
                <img src="images/expired.png" alt="410 Page Expired" class="w-full">
            </div>
        </div>

        <div class="text-center">
            <h1 class="text-4xl text-white drop-shadow-lg">Time's up!</h1>
            <p class="text-xl pt-2 text-coral">You took too long.</p>
