    ...
    <div class="mx-auto w-full max-w-screen-lg flex flex-col items-center justify-center gap-5 md:gap-10">
        <div class="relative w-full max-w-md">
            <div class="w-full mx-auto overflow-hidden rounded-xl">
                <img src="images/unavailable.png" alt="503 Service Unavailable" class="w-full">
            </div>
        </div>

        <div class="text-center">
            <h1 class="text-4xl text-white drop-shadow-lg">Hang tight!</h1>
            <p class="text-xl pt-2 text-coral">We'll be back soon.</p>

            <p class="max-w-md mx-auto pt-6 font-normal text-sm text-gray-300 dark:text-dolphin leading-relaxed">
                Our servers are currently down for maintenance. If you need immediate assistance, please contact support.
            </p>
