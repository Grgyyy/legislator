                        ...
                        ->action(function ($record) {
                            try {
                                ...
                                if ($skillsPriority->available_slots < $slots) {
                                    $message = "Insufficient Target Beneficiaries for the Skill Priority of {$quali->trainingProgram->title} under District {$record->district->name} in {$record->district->province->name}.";
