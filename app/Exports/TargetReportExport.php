...
class TargetReportExport implements FromQuery, WithHeadings, WithStyles, WithMapping
{
    private $columns = [
        'region_name' => 'Region',
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        // Set cell values
        $sheet->setCellValue("A15", "Region");
        $sheet->setCellValue("B15", "Province");
        $sheet->setCellValue("C15", "Name of Institution");
        $sheet->setCellValue("D15", "Qualification Title");
        $sheet->setCellValue("E15", "Number of slots");
        $sheet->setCellValue("F15", "PER CAPITA COST");
        $sheet->setCellValue("F16", "Training Cost");
        $sheet->setCellValue("G16", "Cost of Toolkit");
        $sheet->setCellValue("H16", "Training Cost");
        $sheet->setCellValue("H15", "TOTAL");
        $sheet->setCellValue("I16", "Cost of Toolkit");
        $sheet->setCellValue("J15", "TOTAL AMOUNT");
