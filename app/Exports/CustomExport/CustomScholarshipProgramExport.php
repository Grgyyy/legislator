...
class CustomScholarshipProgramExport extends ExcelExport implements WithDrawings, WithColumnWidths
{
    public function headings(): array
    {
        return [
            ...
            [''],
            ['Code', 'Scholarship Program', 'Description'],
        ];
    }
