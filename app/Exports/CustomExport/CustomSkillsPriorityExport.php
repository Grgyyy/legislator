...
class CustomSkillsPriorityExport extends ExcelExport implements WithDrawings
{
    public function headings(): array
    {
        return [
            ...
            ['SKILLS PRIORITY'],
            [''],
            ['Province', 'District', 'LOT Name', 'Qualification Titles', 'Available Slots', 'Total Slots', 'Year'],
        ];
    }
