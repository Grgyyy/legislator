...
class CustomQualificationTitleExport extends ExcelExport implements WithDrawings
{
    public function headings(): array
    {
        return [
            ...
            [''],
            ['Qualification Code', 'SOC Code', 'Qualification Type', 'NC Level', 'Qualification Title', 'Scholarship Program', 'TVET Sector', 'Priority Sector'],
        ];
    }
