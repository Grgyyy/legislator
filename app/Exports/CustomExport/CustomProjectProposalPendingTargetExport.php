...
class CustomProjectProposalPendingTargetExport extends ExcelExport implements WithDrawings, WithColumnWidths
{
    public function headings(): array
    {
        return [
            ...
            ['Central Office (CO)'],
            ['PENDING PROJECT PROPOSAL TARGETS'],
            [''],
            [
                'Fund Source',
                'Source of Fund',
