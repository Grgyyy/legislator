...
class CustomProjectProposalProgramExport extends ExcelExport implements WithDrawings
{
    public function headings(): array
    {
        return [
            ...
            [''],
            ['SOC Code', 'Qualification Title', 'Scholarship Program', 'TVET Sector', 'Priority Sector'],
        ];
    }
